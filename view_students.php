<?php
		...
		$sql2 = oci_parse($conn,"select * from student");
		oci_execute($sql2);	

		echo "<table border=1 style='width:1080px'>";
			echo "<tr><th>ID</th><th>First Name</th><th>Last Name</th><th>Father's Name</th><th>Gender </th><th>Blood Group</th><th>DOB</th><th>CNIC</th><th>Email </th>
