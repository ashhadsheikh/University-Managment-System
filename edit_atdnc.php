	...
	<form action='edit_attend.php' method='post'>
		...
		<h2>Student ID     <input type="text" name="roll"></h2><br>
	<h2>Date</h2>
				<select name="Day" style="color:#3399cc;">
			...
			<select name="Mon" style="color:#3399cc;">
				...
				<option value="DEC">December</option>
						...
						<select name="Year" style="color:#3399cc;">
			...
			<br>
			<h2>Status
						<select name="Status" style="color:#3399cc;">
